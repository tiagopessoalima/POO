...
| **3** | Classes e Objetos em Python | Criar classes, instanciar objetos, definir atributos e métodos | [Aula](Aula_03_(POO).ipynb), [Apostila](Apostila_03_(POO).pdf), Exercícios, [Podcast](Podcast_01_(POO).mp3) |
