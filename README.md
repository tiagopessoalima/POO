...
| **3** | Classes e Objetos em Python | Criar classes, instanciar objetos, definir atributos e métodos | [Aula](Aula_03_(POO).ipynb), [Apostila](Apostila_03_(POO).pdf), [Exercício](Exercicio_03_(POO).pdf), [Podcast](Podcast_03_(POO).mp3) |
...
| **6** | Encapsulamento | Usar `@property`, getters e setters | [Aula](Aula_05_(POO).ipynb), [Apostila](Apostila_05_(POO).pdf), [Exercício](Exercicio_05_(POO).pdf), [Podcast](Podcast_05_(POO).mp3)  |
