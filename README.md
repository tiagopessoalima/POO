...
| ------ | ------------------ | --------- | ----------------- |
| **1** | Introdução à POO – conceitos básicos e paradigmas | Entender paradigmas e vantagens da POO | [Aula](Semana_01_(POO).ipynb), [Apostila](Semana_01_(POO).pdf), [Podcast](Semana_01_(POO).mp3), Exercícios |
